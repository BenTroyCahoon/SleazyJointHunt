...
const HuntDetails = ({ route }) => {
  ...
  const latitudeMid = (startPoint.latitude + (endPoint?.latitude || startPoint.latitude)) / 2;
  const longitudeMid = (startPoint.longitude + (endPoint?.longitude || startPoint.longitude)) / 2;
  ...
  return (
    ...
    //       latitudeDelta: latitudeDelta * 1.5, // justera för att se alla markörer
    //       longitudeDelta: longitudeDelta * 1.5, // justera för att se alla markörer
    //     }}
    //     >
    ...
    //         coordinate={endPoint}
    //         title="Slutpunkt"
    //         pinColor="red" // Färg för slutpunkten
    //       />
    //     )}
    //     </MapView>
    //   </View>
